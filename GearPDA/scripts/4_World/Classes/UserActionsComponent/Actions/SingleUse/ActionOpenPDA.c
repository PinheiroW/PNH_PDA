class ActionOpenPDA extends ActionSingleUseBase
{
	void ActionOpenPDA()
	{
		if (GearPDADebugMode) Print(GearPDAModPreffix + "ActionOpenPDA construct.");
	...
	{		
		...
		if (GearPDADebugMode) Print(GearPDAModPreffix + "ActionOpenPDA execute => Plug: " + pluginGearPDA);
